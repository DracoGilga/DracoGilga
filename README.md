...
<div align="left">
  <p>
    ✔ Hello everyone, my name is Cesar. 😇😎<br>
    ✔ I am a <strong>Software Engineer</strong> graduated from Universidad Veracruzana.<br>
    ✔ Microsoft LSA --- BETA<br>
    ✔ Currently based in Veracruz, Mexico.<br>
    ✔ I specialize in <strong>Full Stack Development</strong> with expertise in <strong>C#, TypeScript, JavaScript, SQL, and NoSQL</strong>.<br>
    ✔ I have experience building scalable solutions using <strong>.NET 8, Node.js, and GraphQL</strong>.<br>
    ✔ I am focused on <strong>Cloud Solutions (Azure & AWS)</strong> and <strong>DevOps</strong> workflows.<br>
    <br>
    🕹 Indie game lover and occasional multiplayer gamer 🕹
  </p>
</div>
...
<img align="right" height="170" src="https://c.tenor.com/CPpux-5u_RkAAAAd/tenor.gif"  />
